...
public class BestSellerBooksRecyclerViewAdapter extends RecyclerView.Adapter<BestSellerBooksRecyclerViewAdapter.BookViewHolder> {
    ...
    public void onBindViewHolder(final BookViewHolder holder, int position) {
        ...
        holder.mRankOrder.setText(Integer.toString(books.get(position).rank) );
        final String imageURL = books.get(position).bookImageUrl;
        Glide.with(context).load(imageURL).into(holder.mBookImage);
    ...
    public class BookViewHolder extends RecyclerView.ViewHolder {
        ...
        public final TextView mRankOrder;
        ...
        public BookViewHolder(View view) {
            ...
            mRankOrder = (TextView) view.findViewById(R.id.ranking);
